  ...
  return (
    <View>
      <View style={styles.background}>
          <Text style={styles.nama}>Hapus Data Siswa</Text>
      </View>
      ...
      <View
        ...
        <View style={[styles.background2, { justifyContent: 'center', alignItems: 'center', borderRadius: 4}]}>
        ...
        <CustomButton onPress={()=>navigation.navigate("Home")} title="Hapus"/>
    </View>
  );
}
